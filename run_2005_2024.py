...
plt.suptitle("log(Price) vs Time - OLS Regression\nUSBond = IEF (7-10 Year Treasury ETF)", fontsize=13, fontweight='bold')
plt.tight_layout()
plt.savefig('plot1_log_2005_2024.png', dpi=150, bbox_inches='tight')
print("\nPlot 1 saved: plot1_log_2005_2024.png")
...
for ax, (name, r) in zip(axes, results.items()):
    ...
    ax.plot(r['series'].index, r['price_pred'], color='red', linewidth=2, linestyle='--', label='Fitted')
    ax.set_title(f"{name} - Actual vs Fitted", fontweight='bold')
    ax.set_xlabel("Date")
    ax.set_ylabel("Price ($)")
    ax.legend(fontsize=8)
plt.suptitle("Actual vs Fitted Price - Original Scale\nUSBond = IEF (7-10 Year Treasury ETF)", fontsize=13, fontweight='bold')
plt.tight_layout()
plt.savefig('plot2_fitted_2005_2024.png', dpi=150, bbox_inches='tight')
print("Plot 2 saved: plot2_fitted_2005_2024.png")
...
plt.suptitle("Regression Residuals - log(Price) Space\nUSBond = IEF (7-10 Year Treasury ETF)", fontsize=13, fontweight='bold')
plt.tight_layout()
plt.savefig('plot3_resid_2005_2024.png', dpi=150, bbox_inches='tight')
print("Plot 3 saved: plot3_resid_2005_2024.png")
...
ax.set_title("CAGR Comparison - All Assets\nUSBond = IEF (7-10 Year Treasury ETF)", fontsize=13, fontweight='bold')
ax.set_ylabel("CAGR (%)")
ax.set_ylim(0, max(cagrs) * 1.3)
plt.tight_layout()
plt.savefig('plot4_cagr_2005_2024.png', dpi=150, bbox_inches='tight')
print("Plot 4 saved: plot4_cagr_2005_2024.png")
...
ax.set_title("Normalised Asset Performance (Start = 100)\nUSBond = IEF (7-10 Year Treasury ETF)", fontsize=13, fontweight='bold')
ax.set_xlabel("Date")
ax.set_ylabel("Normalised Price (Base = 100)")
ax.legend(fontsize=10)
plt.tight_layout()
plt.savefig('plot5_norm_2005_2024.png', dpi=150, bbox_inches='tight')
print("Plot 5 saved: plot5_norm_2005_2024.png")
