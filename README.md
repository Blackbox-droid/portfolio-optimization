...
The pipeline covers supervised return prediction, macroeconomic regime detection, and portfolio backtesting.
An optional supplementary EDA step adds log-linear asset trend analysis, long-run CAGR summaries, and return-correlation analysis for the 4-asset universe.

## Current Project Scope

- **Stage 1:** processed daily asset data and monthly macro features are stored under `data/processed`.
...
Optional supplementary asset EDA:
...
- Supplementary asset trend summary: `artifacts/tables/mid_review/asset_trend_regression_summary.csv`
- Supplementary asset return correlation: `artifacts/tables/mid_review/asset_return_correlation.csv`
...
- The supplementary log-linear trend regression is descriptive EDA for long-run trend/CAGR analysis; it is not used as the main predictive model in Stage 2.
