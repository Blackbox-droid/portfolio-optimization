...
print("\n" + "="*80)
print("  LOG-LINEAR REGRESSION RESULTS - ALL ASSETS  (2010-2020)")
print("="*80)
...
plt.suptitle("log(Price) vs Time - OLS Regression (2010-2020)", fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig('plot1_log_regression_2010_2020.png', dpi=150, bbox_inches='tight')
print("\nPlot 1 saved: plot1_log_regression_2010_2020.png")
...
for ax, (name, r) in zip(axes, results.items()):
    ...
    ax.set_ylabel("Price ($)")
    ax.legend(fontsize=8)
plt.suptitle("Actual vs Fitted Price - Original Scale (2010-2020)", fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig('plot2_actual_fitted_2010_2020.png', dpi=150, bbox_inches='tight')
print("Plot 2 saved: plot2_actual_fitted_2010_2020.png")
...
plt.suptitle("Regression Residuals - log(Price) Space (2010-2020)", fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig('plot3_residuals_2010_2020.png', dpi=150, bbox_inches='tight')
print("Plot 3 saved: plot3_residuals_2010_2020.png")
...
ax.set_title("CAGR Comparison - All Assets (2010-2020)", fontsize=13, fontweight='bold')
ax.set_ylabel("CAGR (%)")
ax.set_ylim(0, max(cagrs) * 1.3)
plt.tight_layout()
plt.savefig('plot4_cagr_2010_2020.png', dpi=150, bbox_inches='tight')
print("Plot 4 saved: plot4_cagr_2010_2020.png")
...
plt.tight_layout()
plt.savefig('plot5_normalised_2010_2020.png', dpi=150, bbox_inches='tight')
print("Plot 5 saved: plot5_normalised_2010_2020.png")
