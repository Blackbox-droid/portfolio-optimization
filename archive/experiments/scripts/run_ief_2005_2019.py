...
plt.tight_layout()
plt.savefig('plot1_log_regression_IEF_2005_2019.png', dpi=150, bbox_inches='tight')
print("\nPlot 1 saved: plot1_log_regression_IEF_2005_2019.png")
...
plt.suptitle("Actual vs Fitted Price - Original Scale (2005-2019)\nUSBond = IEF (7-10 Year Treasury ETF)",
             fontsize=13, fontweight='bold')
plt.tight_layout()
plt.savefig('plot2_actual_fitted_IEF_2005_2019.png', dpi=150, bbox_inches='tight')
print("Plot 2 saved: plot2_actual_fitted_IEF_2005_2019.png")
...
plt.suptitle("Regression Residuals - log(Price) Space (2005-2019)\nUSBond = IEF (7-10 Year Treasury ETF)",
             fontsize=13, fontweight='bold')
plt.tight_layout()
plt.savefig('plot3_residuals_IEF_2005_2019.png', dpi=150, bbox_inches='tight')
print("Plot 3 saved: plot3_residuals_IEF_2005_2019.png")
...
plt.tight_layout()
plt.savefig('plot4_cagr_IEF_2005_2019.png', dpi=150, bbox_inches='tight')
print("Plot 4 saved: plot4_cagr_IEF_2005_2019.png")
...
plt.tight_layout()
plt.savefig('plot5_normalised_IEF_2005_2019.png', dpi=150, bbox_inches='tight')
print("Plot 5 saved: plot5_normalised_IEF_2005_2019.png")
