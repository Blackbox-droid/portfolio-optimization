...
# ── Step 2: Download SP500, Gold, IEF from Yahoo Finance ─────────────
YF_TICKERS = {
    'SP500'  : '^GSPC',
    'Gold'   : 'GLD',
    'USBond' : 'IEF',       # 7-10 Year Treasury ETF (replacing TLT)
}
...
plt.suptitle("log(Price) vs Time — OLS Regression  (2005–2019)\n"
...
plt.suptitle("Actual vs Fitted Price — Original Scale  (2005–2019)\n"
             "USBond = IEF (7-10 Year Treasury ETF)",
             fontsize=13, fontweight='bold')
plt.tight_layout()
plt.show()
...
plt.suptitle("Regression Residuals — log(Price) Space  (2005–2019)\n"
             "USBond = IEF (7-10 Year Treasury ETF)",
             fontsize=13, fontweight='bold')
plt.tight_layout()
plt.show()
...
ax.set_title("CAGR Comparison — All Assets  (2005–2019)\n"
             "USBond = IEF (7-10 Year Treasury ETF)",
             fontsize=13, fontweight='bold')
ax.set_ylabel("CAGR (%)")
