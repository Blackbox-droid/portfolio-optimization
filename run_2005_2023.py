...
print("\n" + "="*80)
print("  LOG-LINEAR REGRESSION RESULTS - ALL ASSETS  (2005-2023)")
...
plt.suptitle("log(Price) vs Time - OLS Regression (2005-2023)\nUSBond = IEF (7-10 Year Treasury ETF)", fontsize=13, fontweight='bold')
plt.tight_layout()
plt.savefig('plot1_log_2005_2023.png', dpi=150, bbox_inches='tight')
print("\nPlot 1 saved: plot1_log_2005_2023.png")
...
for ax, (name, r) in zip(axes, results.items()):
    ...
    ax.set_ylabel("Price ($)")
    ax.legend(fontsize=8)
plt.suptitle("Actual vs Fitted Price - Original Scale (2005-2023)\nUSBond = IEF (7-10 Year Treasury ETF)", fontsize=13, fontweight='bold')
plt.tight_layout()
plt.savefig('plot2_fitted_2005_2023.png', dpi=150, bbox_inches='tight')
print("Plot 2 saved: plot2_fitted_2005_2023.png")
...
plt.suptitle("Regression Residuals - log(Price) Space (2005-2023)\nUSBond = IEF (7-10 Year Treasury ETF)", fontsize=13, fontweight='bold')
plt.tight_layout()
plt.savefig('plot3_resid_2005_2023.png', dpi=150, bbox_inches='tight')
print("Plot 3 saved: plot3_resid_2005_2023.png")
...
ax.set_title("CAGR Comparison - All Assets (2005-2023)\nUSBond = IEF (7-10 Year Treasury ETF)", fontsize=13, fontweight='bold')
ax.set_ylabel("CAGR (%)")
ax.set_ylim(0, max(cagrs) * 1.3)
plt.tight_layout()
plt.savefig('plot4_cagr_2005_2023.png', dpi=150, bbox_inches='tight')
print("Plot 4 saved: plot4_cagr_2005_2023.png")
...
plt.tight_layout()
plt.savefig('plot5_norm_2005_2023.png', dpi=150, bbox_inches='tight')
print("Plot 5 saved: plot5_norm_2005_2023.png")
